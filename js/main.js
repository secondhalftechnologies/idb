...
/*function initialize() {
  ...
  var coordLat = 19.004486;
  var coordLng = 72.822799;
  var delta
...
function woocommerce_price_slider(){
  ...
  window.woocommerce_price_slider_params = {
    'currency_pos' : 'right',
    'currency_symbol' : '<sup><i class="fa fa-rupee" style="display:inline;"></i></sup>',
  }
...
$(document).ready(function() {
  ...
  /***********   twitter   ********/
  /**/
  /*change by punit $('.twitter-carousel').tweet({
  ...
  /***********   twitter   ********/
  /**/
  /* change by punit $('.twitter-1').tweet({
    username: 'Creative_WS',
    count: 8,
    loading_text: 'loading twitter feed...',
  ...
  /* wrap tweet list for 2 elements */
  /**/
  /*change by punit $('.twitter-1 .tweet_list').addClass("testimonials-carousel").addClass("owl-carousel");;*/
