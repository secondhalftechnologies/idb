						        ...
						        <div class="control-group">
						            <ul class="categories-filter animate-dropdown">
						                <li class="dropdown">
						                    ...
						                    <a class="dropdown-toggle"  data-toggle="dropdown" href="category-grid.html">all</a>
				    ...
				    <div class="yamm navbar" style="min-height:0px;">
				            ...
				            <div class="collapse navbar-collapse" id="mc-horizontal-menu-collapse">
				                <ul class="nav navbar-nav">
				                    <li class="dropdown">
				                        <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">Raw</a>
				                        <ul class="dropdown-menu">
				                            <li>
				                    ...
				                    <li class="dropdown">
				                        <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">Formulation</a>
				                        <ul class="dropdown-menu">
				                            <li>
												<div class="yamm-content">
												    <div class="row">
				                    ...
				                    <li class="dropdown">
				                        <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">Surgical</a>
				                        <ul class="dropdown-menu">
				                            <li><a href="#">Computer Cases &amp; Accessories</a></li>
				                            <li><a href="#">CPUs, Processors</a></li>
				                            <li><a href="#">Fans, Heatsinks &amp; Cooling</a></li>
            ...
            <footer id="footer" class="color-bg">
                ...
                <div class="copyright-bar">
                    <div class="container">
                        <div class="col-xs-12 col-sm-6 no-margin">
                            <div class="copyright">
                                &copy; <a href="index.html">Indian Dava Bazar</a> - all rights reserved
                            </div><!-- /.copyright -->
                        </div>
                        <div class="col-xs-12 col-sm-6 no-margin">
