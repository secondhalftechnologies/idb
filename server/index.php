                ...
                <div class="row">
                    <div id="hero">
                        <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-lg">
                            <div class="item" style="background-image: url(assets/images/sliders/1.jpg);"></div>
                            <div class="item" style="background-image: url(assets/images/sliders/2.jpg);"></div>
