...
<body  class="<?php echo $theme_name;?>" data-theme="<?php echo $theme_name;?>" >
    ...
    <script type="text/javascript">
		...
		{  
			...
			{
				var sendInfo 	= {"order_status":order_status,"daterange":daterange,"start_date":start_date,"end_date":end_date,"row_limit":row_limit, "search_text":search_text, "test_satish_order":1, "page":page};
				var desg_load 	= JSON.stringify(sendInfo);				
				$.ajax({
					url: "test_satish_order.php?",
					type: "POST",
					data: desg_load,
...
function datefilter(date_type,valu)
{
	...
	{	
		...
		function comments(ord_id)
		{
			var  update_comments = "1";			
			var  comment         = $("#comment_"+ord_id).val();
			
			    loading_show();
				var sendInfo 	= {"ord_id":ord_id,"update_comments":update_comments,"comment":comment};
