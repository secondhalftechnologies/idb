...
function getProperty($var){
  ...
  if($var == 'key') Return 'W4xm363OLpSnG0ZO'; 
	if($var == 'password') Return 'HEQGduLDQSHGnKX0f36z8O7kz'; 
	if($var == 'parentkey') Return 'W4xm363OLpSnG0ZO'; 
	if($var == 'parentpassword') Return 'HEQGduLDQSHGnKX0f36z8O7kz'; 	
  ...
  if($var == 'shipdate') Return '2016-04-21';
	...
	if($var == 'searchlocationphonenumber') Return '9405487216';
