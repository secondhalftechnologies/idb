			...
			{  
				$start_offset++; ?>
      			<tr>
                    ...
                    <td  style="text-align:center"><?php echo $vals['user_type']; ?>			</td>
                    <td style="text-align:center"><a href="edit_user.php?id=<?php echo $vals['id'] ?>" title="Edit"><?php echo ucwords($vals['fullname']); ?></a></td>
