        ...
        <table id="tblassigntype" class="table table-bordered dataTable dataTable-scroll-x" width="98%">
            <thead>
              <tr>
                ...
                <th style="text-align:center">User Level Name</th>
                <th style="text-align:center">Created Date</th>
                <th style="text-align:center">Created By</th>
                <th style="text-align:center" style="text-align:center">Modified Date</th>
              ...
              <?php  
					...
					{			
                		...
                		<tr>
                    		...
                    		<td style="text-align:center"><?php echo ucwords($row['at_name']); ?></td>
                    		<td style="text-align:center"><?php echo $row['createddt']; ?></td>
                    		<td style="text-align:center"><?php echo $row['createdby']; ?></td>
                    		<td style="text-align:center"><?php echo $row['modifieddt']; ?></td>
                    		<td style="text-align:center"><?php echo $row['modifiedby']; ?></td>                            
                    		...
                    		<td style="text-align:center"><div align="center" style="margin-right:5px"><a href="edit_admintype.php?at_id=<?php echo $row['at_id'] ?>" title="Edit"  class="icon-edit">Edit</a></div></td>
