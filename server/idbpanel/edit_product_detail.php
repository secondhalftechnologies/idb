                                ...
                                <div class="box-content nopadding">
                                	...
                                	<form id="frm_update_prod" class="form-horizontal form-bordered form-validate" enctype="multipart/form-data" >
                                        ...
                                        <div class="control-group" style="clear: both">
                                            ...
                                            <div class="controls">
                                                <input type="text" placeholder="Product Name" id="prod_name" name="prod_name" class="input-xlarge" value="<?php echo $prod_row['prod_name'] ?>" data-rule-required="true" />
                                            </div>
                                        </div><!--Category=====-->
                                       ...
                                       <!--========================Certificate of Analysis /Authenticity===============================//-->
                                        ...
                                        <div class="control-group " style="clear:both">
                                         ...
                                         <button type="submit" name="reg_submit_add" class="btn-success">Update Product</button>
                                        </div>
