		...
		if($result_load_data)		
		{
			...
			{		
				...
				$gst_data .= '<table id="tbl_user" class="table table-bordered dataTable">';
    	 		$gst_data .= '<thead>';
    	  		$gst_data .= '<tr  style="text-align:center">';
         		$gst_data .= '<th  style="text-align:center">Sr. No.</th>';
				$gst_data .= '<th  style="text-align:center">Id</th>';

				$gst_data .= '<th  style="text-align:center">GST Value</th>';

				$gst_data .= '<th style="text-align:center">Created By</th>';
				$gst_data .= '<th style="text-align:center">Created</th>';
				$gst_data .= '<th style="text-align:center">Modified By</th>';
				$gst_data .= '<th style="text-align:center">Modified</th>';	

				$dis = checkFunctionalityRight("view_gst_management.php",3);

				if($dis)
				{					
					$gst_data .= '<th style="text-align:center">Status</th>';											
				}
				...
				if($edit)
				{					
					$gst_data .= '<th style="text-align:center">Edit</th>';			
				}	
				...
				if($delete)
				{					
					$gst_data .= '<th style="text-align:center"><div style="text-align:center"><input type="button"  value="Delete" onclick="multipleDelete();" class="btn-danger"/></div></th>';
				}					
          		$gst_data .= '</tr>';
      			$gst_data .= '</thead>';
      			$gst_data .= '<tbody>';
				...
				{
	    		  	$gst_data .= '<tr>';				
					$gst_data .= '<td style="text-align:center">'.++$start_offset.'</td>';				
					$gst_data .= '<td style="text-align:center">'.$row_load_data['gst_id'].'</td>';
					...
					$gst_data .= '<td style="text-align:center">'.ucwords($row_load_data['name_gst_created_by']).'</td>';
					$gst_data .= '<td  style="text-align:center">'.$row_load_data['gst_created'].'</td>';
					$gst_data .= '<td style="text-align:center">'.ucwords($row_load_data['name_gst_modified_by']).'</td>';
					$gst_data .= '<td style="text-align:center">'.$row_load_data['gst_modified'].'</td>';
