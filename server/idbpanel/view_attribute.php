...
<body  class="<?php echo $theme_name;?>" data-theme="<?php echo $theme_name;?>" >
	...
	?> <!-- Navigation Bar -->
            ...
            <div id="main" style="margin-left:0px !important">
				...
				<?php
				/* this function used to add navigation menu to the page*/
				breadcrumbs($home_url,$home_name,'View Applications',$filename,$feature_name);
				/* this function used to add navigation menu to the page*/
				?>
                        <div class="row-fluid">
                            <div class="span12">
                                <div class="box box-color box-bordered">
                                    ...
                                    <?php
										...
										{
											?>
                                            <button type="button" class="btn-info" onClick="addMoreSpec('','add')" ><i class="icon-plus"></i>&nbspAdd Application</button>
  											<?php
										}
									?>
                                ...
                                <?php
                                    ...
                                    <div class="box-title">
                                        <h3>
                                            <i class="icon-table"></i>
                                            Excel Bulk Upload For Application
                                        </h3>
                ...
                <div class="container-fluid" id="div_add_spec" style="display:none">
					<?php
						/* this function used to add navigation menu to the page*/
						breadcrumbs($home_url,$home_name,'Add Application',$filename,$feature_name);
						/* this function used to add navigation menu to the page*/
					?>
                    <div class="row-fluid">
                            <div class="span12">
                ...
                <div class="container-fluid" id="div_edit_spec" style="display:none">
					<?php
						/* this function used to add navigation menu to the page*/
						breadcrumbs($home_url,$home_name,'Edit Application',$filename,$feature_name);
						/* this function used to add navigation menu to the page*/
					?>
                    <div class="row-fluid">
                            <div class="span12">
                ...
                <div class="container-fluid" id="div_view_spec_details" style="display:none">
					<?php
						/* this function used to add navigation menu to the page*/
						breadcrumbs($home_url,$home_name,'View Application Details',$filename,$feature_name);
						/* this function used to add navigation menu to the page*/
					?>
                    <div class="row-fluid">
                            <div class="span12">
