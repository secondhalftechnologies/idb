...
<body  class="<?php echo $theme_name;?>" data-theme="<?php echo $theme_name;?>" >
					...
					<div class="span12">
						<div class="box box-color box-bordered">
							<div class="box-title">
                                ...
                                <select name="order_status" id="order_status"  class="select2-me input-medium" data-rule-required="true" onChange="loadOrderData();">
                                        <option value="">Select Status</option>
                                        <?php   $sql_get_status 			= " SELECT * FROM `tbl_order_status` WHERE `orstat_status` = 1 order by orstat_sort_order";
												...
												{
										?>
                                                <option value="<?php echo $status_row['orstat_id']; ?>"><?php echo ucwords($status_row['orstat_name']); ?></option>
                                ...
                                <div style="float:left;width:20%;"> 
                                        ...
                                        <select name="daterange1" id="daterange1"  class="select2-me input-medium" data-rule-required="true" onChange="datefilter(this.value,1);loadOrderData();">
                                        ...
                                        <div style="float:left;width:20%;"> 
                                        	<div id = "start" style="float:left;width:30%;">                                                              
                                        		<label id = "labelstart" style="display:none;text-align:center;">Start Date</label>
											</div>
                                            <div style="float:left;width:50%;">                                                              
												<input type="text" name="start_date" id="start_date" onChange="loadOrderData();"   class="form-control datepicker input-small"  data-rule-required="true" style="display:none;height:22px;width:100%">
                                        	</div>
                                        	<div id = "start" style="float:left;width:30%;"> 
                                        		<label id = "labelend" style="display:none;text-align:center;">End Date</label>
											</div>
                                            <div style="float:left;width:50%;">                                                 
                                        		<input type="text" name="end_date" id="end_date" size="18" onChange="loadOrderData();"  class="form-control datepicker input-small"  data-rule-required="true" style="display:none;height:22px;width:100%" >
											</div>
                                        </div>
    ...
    <script type="text/javascript">
		...
		{  
			...
			{
				var sendInfo 	= {"order_status":order_status,"daterange":daterange,"start_date":start_date,"end_date":end_date,"row_limit":row_limit, "search_text":search_text, "load_orders":1, "page":page};
		...
		function sendOrderEmail(type,towhom,type_id)
		{
                        if(type==1)
			{
				var shipping_date =$('#cart_ord_date'+type_id).val();
			}
			else
			{
				var shipping_date =$('#ord_date'+type_id).val();
			}
			var sendInfo 	= {"towhom":towhom,"type_id":type_id,type:type,"send_Order_mail":1,"shipping_date":shipping_date};
...
function comments(cust_id,comment)
		{
		...
		function feedback(ord_id,feedback)
		{
				var  update_feedback = "1";		
			        loading_show();
				var sendInfo 	= {"ord_id":ord_id,"update_feedback":update_feedback,"feedback":feedback};
			        var page_module_load 	= JSON.stringify(sendInfo);				
				$.ajax({
					url: "load_orders.php?",
					type: "POST",
