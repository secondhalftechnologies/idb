                                ...
                                <div class="box box-color box-bordered">
                                    <div class="box-title">
                                        <h3>
                                            ...
                                            <button type="button" class="btn-info_1" style= "float:right" onClick="back_to_main('div_add_cat','div_view_cat');loadSubjectData();" ><i class="icon-arrow-left"></i>&nbsp Back </button>                                       
                                    </div> <!-- header title-->
                                    <div class="box-content nopadding" >
								...
								<div class="box box-color box-bordered">
									<div class="box-title">
										<h3>
											...
											<button type="button" class="btn-info_1" style= "float:right" onClick="back_to_main('div_edit_cat','div_view_cat');loadSubjectData();" ><i class="icon-arrow-left"></i>&nbsp Back </button>                                                                                                                          
									</div> <!-- header title-->
									<div class="box-content nopadding" >
                                ...
                                <div class="box box-color box-bordered">
                                    <div class="box-title">
                                        <h3>
                                            ...
                                            <button type="button" class="btn-info_1" style= "float:right" onClick="back_to_main('div_view_cat_details','div_view_cat');loadSubjectData();" ><i class="icon-arrow-left"></i>&nbsp Back </button>                                                                                   
                                    </div> <!-- header title-->
                                    <div class="box-content nopadding" >
