...
<body  class="<?php echo $theme_name;?>" data-theme="<?php echo $theme_name;?>" >
	...
	<?php 
	/* this function used to add navigation menu to the page*/ 
	breadcrumbs($home_url,$home_name,'View Level',$filename,$feature_name); 
	/* this function used to add navigation menu to the page*/ 
	?>          
                        <div class="row-fluid">
                            <div class="span12">
                                <div class="box box-color box-bordered">
                                    ...
                                    <?php
										...
										{
											?>
                                            <button type="button" class="btn-info" onClick="addMoreCategory('','add')" ><i class="icon-plus"></i>&nbspAdd Level</button>
  											<?php		
										}
									?>
            ...
            <div id="div_add_cat" style="display:none;">
                	<div class="container-fluid"> 
                        <?php 
                        /* this function used to add navigation menu to the page*/ 
                        breadcrumbs($home_url,$home_name,'Add Level',$filename,$feature_name); 
                        /* this function used to add navigation menu to the page*/ 
                        ?>          
                        <div class="row-fluid">
                            <div class="span12">
			...
			<div id="div_edit_cat" style="display:none;">
                	<div class="container-fluid"> 
                        <?php 
                        /* this function used to add navigation menu to the page*/ 
                        breadcrumbs($home_url,$home_name,'Edit Level',$filename,$feature_name); 
                        /* this function used to add navigation menu to the page*/ 
                        ?>          
                        <div class="row-fluid">
                            <div class="span12">
			...
			<div id="div_error_cat" style="display:none;">
                	<div class="container-fluid"> 
                        <?php 
                        /* this function used to add navigation menu to the page*/ 
                        breadcrumbs($home_url,$home_name,'Update Error Level',$filename,$feature_name); 
                        /* this function used to add navigation menu to the page*/ 
                        ?>          
                        <div class="row-fluid">
                            <div class="span12">
            ...
            <div id="div_view_cat_details" style="display:none;">
                	<div class="container-fluid"> 
                        <?php 
                        /* this function used to add navigation menu to the page*/ 
                        breadcrumbs($home_url,$home_name,'Level Details',$filename,$feature_name); 
                        /* this function used to add navigation menu to the page*/ 
                        ?>          
                        <div class="row-fluid">
                            <div class="span12">
				...
				$.ajax({
						...
						success: function(response) 
						{
							...
							if(data.Success == "Success") 
							{
								...
								window.location.assign("view_level.php?pag=<?php echo $title; ?>");
								loading_hide();
							} 
							else 
							{
		...
		// ******************************************************************************************
		function changeLevelSlug(level_id)
		{
			loading_show();
			level_id		= parseInt(level_id);
			var level_slug	= $("textarea#"+level_id+"level_slug").val();
			if(level_id == "" && level_slug == "")
			{
				$("#model_body").html('<span style="style="color:#F00;"> Id or Slug info not available</span>');
				$('#error_model').modal('toggle');		
				loading_hide();		
			}
			else
			{
				change_status 	= 1;
				var sendInfo 	= {"level_id":level_id, "level_slug":level_slug, "change_level_slug":1};
				var level_info 	= JSON.stringify(sendInfo);
				$.ajax({
					url: "load_level.php",
					type: "POST",
					data: level_info,
