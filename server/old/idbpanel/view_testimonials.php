    ...
    <div class="container-fluid" id="content">
		<div id="main" style="margin-left:0px !important">
        	<div class="container-fluid" id="div_view_cat">                
				<?php 
                /* this function used to add navigation menu to the page*/ 
                breadcrumbs($home_url,$home_name,'View Testinomials',$filename,$feature_name); 
                /* this function used to add navigation menu to the page*/ 
                ?>          
                <div class="row-fluid">
                    <div class="span12">
                        <div class="box box-color box-bordered">
                            ...
                            <?php
                                ...
                                {
                                    ?>
                                    <button type="button" class="btn-info" onClick="addMoreTestimonial('','add')" ><i class="icon-plus"></i>&nbspAdd Testimonials</button>
                                    <?php		
                                }
                            ?>
            ...
            <div id="div_add_cat" style="display:none;">
                <div class="container-fluid"> 
                    <?php 
                    /* this function used to add navigation menu to the page*/ 
                    breadcrumbs($home_url,$home_name,'Add Testinomial',$filename,$feature_name); 
                    /* this function used to add navigation menu to the page*/ 
                    ?>          
                    <div class="row-fluid">
                        <div class="span12">
			...
			<div id="div_edit_cat" style="display:none;">
                <div class="container-fluid"> 
                    <?php 
                    /* this function used to add navigation menu to the page*/ 
                    breadcrumbs($home_url,$home_name,'Edit Testinomial',$filename,$feature_name); 
                    /* this function used to add navigation menu to the page*/ 
                    ?>          
                    <div class="row-fluid">
                        <div class="span12">
            ...
            <div id="div_view_cat_details" style="display:none;">
                <div class="container-fluid"> 
                    <?php 
                    /* this function used to add navigation menu to the page*/ 
                    breadcrumbs($home_url,$home_name,'Testinomial Details',$filename,$feature_name); 
                    /* this function used to add navigation menu to the page*/ 
                    ?>          
                    <div class="row-fluid">
                        <div class="span12">
		...
		{			
			...
			{
				delete_testimonial 	= 1;
				var sendInfo 	= {"batch":batch, "delete_testimonial":delete_testimonial};
		...
		function changeStatus(testi_id,curr_status)
		{
			loading_show();
			if(testi_id == "" && curr_status == "")
			{
			...
			{
				change_status 	= 1;
				var sendInfo 	= {"testi_id":testi_id, "curr_status":curr_status, "change_status":change_status};
		...
		function changesortorder(new_order,testi_id)
		{
			loading_show();			
			if(testi_id == "" && new_order == "")
			{
				$("#model_body").html('<span style="style="color:#F00;"> User id or Status to change not available</span>');
			}
			else
			{
				testi_id =parseInt(testi_id);
				if(testi_id=="")
				{
					testi_id=1;
				}
				change_sort_order 	= 1;
				var sendInfo 	= {"testi_id":testi_id, "new_order":new_order, "change_sort_order":change_sort_order};
		...
		function addMoreTestimonial(testi_id,req_type)
		{
			...
			var sendInfo = {"testi_id":testi_id,"req_type":req_type,"load_add_test_part":"1"};
			var cat_load = JSON.stringify(sendInfo);
			$.ajax({
					url: "load_testimonials.php?",
					type: "POST",
				...
				$.ajax({
					...
					async:true,						
						...
						{   data = JSON.parse(response);
							...
							if(data.Success == "Success") 
							{   
							   alert("Testinomial Successfully Added");
					...
					async:true,						
						...
						{   data = JSON.parse(response);
							...
							{   
								...
								alert("Testinomial Successfully Updated");	
								$('#div_view_cat').css("display", "block");
