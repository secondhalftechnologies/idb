...
<html lang="en">
	...
	<head>
        ...
        <title>Vendor Policy - Indian Dava Bazar</title>
	...
	<body>
		<div class="wrapper">
            ...
            <?php  breadcrumbs(array('vendor-policy'=>"Vendor Policy")); ?>
			<!-- ============================================================= HEADER : END ======================================================== -->
                ...
                <div class="container inner-top-xs inner-bottom-sm">
                    <div class="row">
                        <div class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
							...
							$result = getRecord('tbl_pages_module',array('page_name'=>'vendor policy'),array(),array(),array());
