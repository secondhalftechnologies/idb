<?php
	...
	if($num_get_comp_info != 0)
	{
		...
		$pickuptime			= $row_get_comp_info['comp_pickuptime'];
		$comp_timedesc      = $row_get_comp_info['comp_timedesc'];
	}
	// ==============================================================================================================================
	...
	{
		$contact_persone  = 'Contact Person\'s';
...
<html lang="en">
	...
	<body>
            			...
            			<div class="col-md-12" >
        					<div class="col-md-3">
                                ...
                                <div class='wrapper-smenu'>
                                    ...
                                    <label for='pictures'>
										...
										$sql_load_data  .= " INNER JOIN tbl_customer_sign as tcs ON tc.cust_id = tcs.sign_userid ";//  Sign 
										$sql_load_data  .= " WHERE cust_id='".$logged_uid."' ";
										$res_load_data   = mysqli_query($db_con,$sql_load_data) or die(mysqli_error($db_con));
										if(mysqli_num_rows($res_load_data)!=0)
										{
                                                	...
                                                	<a id="2" href="javascript:void(0);" onclick="showDiv('comp_info','2');">
														<?php echo $org_menu_title; ?> Information 
                                                         <?php
															...
															if(checkExist('tbl_customer_company',array('comp_user_id'=>$logged_uid)))
															{
																echo '<i class="fa fa-check" aria-hidden="true"></i>';
															}
        					...
        					<div class="col-md-9">
                            	...
                            	<div class="cls_mainmenu active" id="profile">
                                    <h2 class="text-center padding20">Login Information</h2>
                                ...
                                <div class="cls_mainmenu" id="comp_info">
                                  <h2 class="text-center padding20">Company Information</h2>
                                  <form role="form" class="register-form cf-style-1" id="frm_comp_info" name="frm_comp_info">
                                    ...
                                    <div class="field-row">
                                      <label class="col-md-3 col-xs-12" for="name">Shop & Establishment no.</label>
                					...
                					<div class="field-row">
                                      <label class="col-md-3 col-xs-12" for="name">Time for pickup<span style="color:#F00">*</span></label>
                                      <input type="text" class="le-input col-md-3 col-xs-12" id="txt_pickuptime" value"" name="txt_pickuptime" data-rule-required="true" />
                					...
                					<div class="field-row">
                                      ...
                                      <div class="clearfix"></div>
                                    </div><!-- Time for pickup Description -->
                                ...
                                <div class="cls_mainmenu" id="urDoc">
                                  ...
                                  <h2 class="text-center padding20">Upload Required Documents</h2>
                                  <?php
                                    if($logged_user_type == 'doctors')
                                    {
	                                  ...
	                                  <input type="hidden" name="hid_userid" id="hid_userid" value="">
	                                   ...
	                                   <?php
	                                    ...
	                                    <div class="field-row">
	                                      ...
	                                      <label class="col-md-3 col-xs-12" for="name">Drug License Image</label>
	                                  ...
	                                  <div id="renewal<?php echo $i; ?>">
	                                   ...
	                                   <?php
	                                    ...
	                                    <?php 
										 ...
										 ?>
	                                     <div class="field-row">
	                                      <label class="col-md-3 col-xs-12" for="name">Hospital Drug License Image</label>
	                                    ...
	                                    <div class="field-row">
	                                      <label class="col-md-3 col-xs-12" for="name">Hospital Drug License Expiry Date</label>
										...
										if($result)
										{
										   ...
										   <?php
											...
											<?php 
											 ...
											 ?>
											 <div class="field-row">
											  <label class="col-md-3 col-xs-12" for="name">Renewal <?php echo $i; ?> Hospital Drug License Image</label>
											...
											<div class="field-row">
											  <label class="col-md-3 col-xs-12" for="name">Renewal <?php echo $i; ?> Hospital Drug License Expiry Date</label>
                            ...
                            <?php  if($licNum)
                             ...
                             <?php  }
                               ...
                               <form role="form" class="register-form cf-style-1" id="<?php echo $frm_lic_name; ?>" name="<?php echo $frm_lic_name; ?>" enctype="multipart/form-data" method="post">
                                  ...
                                  <?php
                                   ...
                                   <?php
                                    ...
                                    <div class="field-row">
                                      <label class="col-md-3 col-xs-12" for="name">20B Drug license Image</label>
                                      <input accept="image/jpeg,image/png,image/jpg,appication/pdf" type="file" name="file_lic_20b_image" id="file_lic_20b_image"  >
                                      <div class="clearfix"></div>
                                    </div><!-- License Image -->
                                    
                                    <div class="field-row">
										  <label class="col-md-3 col-xs-12" for="name">20B Drug license Expiry Date</label>
                               ...
                               <!--=========================Start : 20B License Number===================================-->
                                  <?php
                                   ...
                                   <?php
                                    ...
                                    <div class="field-row">
                                      <label class="col-md-3 col-xs-12" for="name">21B Drug license Image</label>
                                      <input accept="image/jpeg,image/png,image/jpg,appication/pdf" type="file" name="file_lic_21b_image" id="file_lic_21b_image" >
                                      <div class="clearfix"></div>
                                    </div><!-- License Image -->
                                    
                                   <div class="field-row">
										  <label class="col-md-3 col-xs-12" for="name">21B Drug license Expiry Date</label>
                               ...
                               <!--=========================Start : 21C License Number===================================-->
								   ...
								   ?>
                                     ...
                                     <div class="field-row">
                                      <label class="col-md-3 col-xs-12" for="name">21C Drug license Image</label>
                               ...
                               <!--=========================End 21L License Number===================================-->
                                ...
                                <div class="cls_mainmenu" id="pan_info">
                                 <h2 class="text-center padding20">PAN Information</h2>
                                  <?php
                                ...
                                <div class="cls_mainmenu" id="tan_info">
                                  <h2 class="text-center padding20">TAN Information</h2>
                                  <?php
                               ...
                               <!--=======================End : Pan Information Dn By Satish 06092017=============================================-->
                                ...
                                <div class="cls_mainmenu" id="gst_info">
                                 <h2 class="text-center padding20">GST Information</h2>
                                  <?php
								   //  Check Record and return single row
                                  ...
                                  <form role="form" class="register-form cf-style-1" id="<?php echo $frm_gst_name; ?>" name="<?php echo $frm_gst_name;?>" enctype="multipart/form-data" method="post">
                                    ...
                                    <?php
									 if($gstRow && $gstRow['gst_ack_image2']!="")
									 {
									 ?>
                                    <div class="field-row">
                                      <label class="col-md-3 col-xs-12" for="name"></label>
                                       <img style="width:200px;height:100px" src="idbpanel/documents/gst/<?php echo $gstRow['gst_ack_image2'];?>" >
                                      <div class="clearfix"></div>
                                    </div><!-- gst Image -->
                                    <?php 
									 }
                                    ...
                                    <?php
									 if($gstRow && $gstRow['gst_ack_image3']!="")
									 {
									 ?>
                                    <div class="field-row">
                                      <label class="col-md-3 col-xs-12" for="name"></label>
                                       <img style="width:200px;height:100px" src="idbpanel/documents/gst/<?php echo $gstRow['gst_ack_image3'];?>" >
                                      <div class="clearfix"></div>
                                    </div><!-- gst Image -->
                                    <?php 
									 }
                                    ...
                                    <?php
									 if($gstRow && $gstRow['gst_ack_image4']!="")
									 {
									 ?>
                                    <div class="field-row">
                                      <label class="col-md-3 col-xs-12" for="name"></label>
                                       <img style="width:200px;height:100px" src="idbpanel/documents/gst/<?php echo $gstRow['gst_ack_image4'];?>" >
                                      <div class="clearfix"></div>
                                    </div><!-- gst Image -->
                                    <?php 
									 }
                             ...
                             <!--=======================Start : Bank Information Dn By Satish 06092017=============================================-->
                                <div class="cls_mainmenu" id="bank_info">
                                  <h2 class="text-center padding20">Bank Information</h2>
                                  <?php
								 //  Check Record and return single row
        ...
        <!--================Start : Dn By satish for timepicker-->
        ...
        <!--================End : Dn By satish for timepicker-->
	...
	//datefilter(2,limit,1,srch);	
	   $( ".datepicker" ).datepicker({
		...
		$('#txt_pickuptime').timepicker({
		        showInputs: false,
		        showMeridian : true,
		        defaultTime : false,
		        showSeconds: false
		    }); 
		$('#txt_pickuptime').val('<?php echo @$pickuptime;?>');	
        </script>
