                            ...
                            <section class="section register">
                                ...
                                <form role="form" class="register-form cf-style-1 form-horizontal form-bordered form-validate" id="frm_register" name="frm_register">
                                    ...
                                    <div class="field-row  control-group controls">
                                        ...
                                        <input type="text" class="le-input col-md-9 col-xs-12" id="txt_mobile" name="txt_mobile" placeholder="Ex. 1234567890" data-rule-required="true" data-rule-number="true" maxlength="10" minlength="10" size="10" >
                                    	<div class="clearfix"></div>
                                    </div><!-- Mobile -->
