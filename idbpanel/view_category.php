                ...
                <div class="container-fluid" id="div_view_cat">
                    ...
                    <div class="row-fluid">
                                ...
                                <div class="box-title">
                               	...
                               	<div class="box-content nopadding">
                                    <?php
                                        ...
                                        {
                                            ?>
                                            <button type="button" class="btn-info" onClick="addMoreCategory('','add')" ><i class="icon-plus"></i>&nbspAdd Category</button>
                                            <?php		
                                        }
                                    ?>
						...
						<div class="box-title">
							<h3>
								<i class="icon-table"></i>
								Excel Bulk Upload For Category
							</h3>
					...
					<div class="box box-color box-bordered">
						...
						<div class="box-content nopadding">
							<div style="padding:10px 15px 10px 15px !important">
								...
								<select name="rowlimit1" id="rowlimit1" onChange="loadErrorData();"  class = "select2-me">
									<option value="10" selected>10</option>
									<option value="25">25</option>
									<option value="50">50</option>
									<option value="100">100</option>
				...
				$.ajax({
						...
						success: function(response) 
						{
							...
							if(data.Success == "Success") 
							{
								...
								window.location.assign("view_category.php?pag=<?php echo $title; ?>");
								loading_hide();
							} 
							else 
							{
