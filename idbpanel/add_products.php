                                ...
                                <div class="box-content nopadding">
                                	...
                                	<form id="frm_add_prod" class="form-horizontal form-bordered form-validate" enctype="multipart/form-data" >
                                      ...
                                      <!--   
                                        ...
                                        <div class="control-group span4">
                                        	<label for="tasktitel" class="control-label">Licence Number<sup class="validfield"><span style="color:#F00;font-size:20px;">*</span></sup></label>
                                           <div class="controls">
                                        ...
                                        <div class="control-group" id="div_ean" style="clear: both;display: none" >
                                        	<label for="tasktitel" class="control-label">EAN Number<sup class="validfield"><span style="color:#F00;font-size:20px;">*</span></sup></label>
                                           <div class="controls">
                                            <input placeholder="EAN Number" type="text" name="txt_ean" id="txt_ean"  class=" input-large" style=""  data-rule-required="true" />
                                           </div>
                                        </div><!--Manufactured by -->
