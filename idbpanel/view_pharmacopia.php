...
<body  class="<?php echo $theme_name;?>" data-theme="<?php echo $theme_name;?>" >
	...
	?> <!-- Navigation Bar --> 
            ...
            <div id="main" style="margin-left:0px !important">
				...
				<?php 
				/* this function used to add navigation menu to the page*/ 
				breadcrumbs($home_url,$home_name,'View Pharmacopia',$filename,$feature_name); 
				/* this function used to add navigation menu to the page*/ 
				?>          
                        <div class="row-fluid">
                            <div class="span12">
                                <div class="box box-color box-bordered">
                                    ...
                                    <?php
										...
										{
											?>
                                            <button type="button" class="btn-info" onClick="addMoreSpec('','add')" ><i class="icon-plus"></i>&nbspAdd Pharmacopia</button>
  											<?php		
										}
									?>                                      
                                ...
                                <?php
                                    ...
                                    <div class="box-title">
                                        <h3>
                                            <i class="icon-table"></i>
                                            Excel Bulk Upload For Pharmacopia
                                        </h3>
                    ...
                    </div> <!-- View pharmacopia-->          
                <div class="container-fluid" id="div_add_spec" style="display:none">                
					<?php 
						/* this function used to add navigation menu to the page*/ 
						breadcrumbs($home_url,$home_name,'Add Pharmacopia',$filename,$feature_name); 
						/* this function used to add navigation menu to the page*/ 
					?>           
                    <div class="row-fluid">
                            <div class="span12">
                                <div class="box box-color box-bordered">
                                    ...
                                    <div class="box-content nopadding">                                     
                                    	<form id="frm_pharmacopia_add" class="form-horizontal form-bordered form-validate" >
                                        	<div id="div_add_pharmacopia_part" class="data_container">
                                        	</div>                                    
                                        </form>
                                    </div>
                                </div>
                ...
                <div class="container-fluid" id="div_edit_spec" style="display:none">   
					<?php 
						/* this function used to add navigation menu to the page*/ 
						breadcrumbs($home_url,$home_name,'Edit Pharmacopia',$filename,$feature_name); 
						/* this function used to add navigation menu to the page*/ 
					?>                                    
                    <div class="row-fluid">
                            <div class="span12">
                                <div class="box box-color box-bordered">
                                    ...
                                    <div class="box-content nopadding">
                                    	<form id="frm_pharmacopia_edit" class="form-horizontal form-bordered form-validate" >
                                        	<div id="div_edit_pharmacopia_part" class="data_container">
                                        	</div>                                    
										</form>                                    
    	                            </div>
                                </div>
                    ...
                    </div> <!-- Edit pharmacopia -->   
				<div class="container-fluid" id="div_error_spec" style="display:none">   
					<?php 
						/* this function used to add navigation menu to the page*/ 
						breadcrumbs($home_url,$home_name,'Edit Error Pharmacopia',$filename,$feature_name); 
						/* this function used to add navigation menu to the page*/ 
					?>                                    
                    <div class="row-fluid">
                            <div class="span12">
                                <div class="box box-color box-bordered">
                                    <div class="box-title">
                                        <h3>
                                            <i class="icon-table"></i>
                                            Edit Error Pharmacopia
                                        </h3>
                                            <button type="button" class="btn-info_1" style= "float:right" onClick="location.reload();" ><i class="icon-arrow-left"></i>&nbsp Back </button>                                               
                                    </div> <!-- header title-->
                                    <div class="box-content nopadding">
                                    	<form id="frm_pharmacopia_error" class="form-horizontal form-bordered form-validate" >
                                        	<div id="div_error_pharmacopia_part" class="data_container">
                                        	</div>                                    
										</form>                                    
    	                            </div>
                                </div>
                    ...
                    </div> <!-- Error pharmacopia -->   
                <div class="container-fluid" id="div_view_pharmacopia_details" style="display:none">                
					<?php 
						/* this function used to add navigation menu to the page*/ 
						breadcrumbs($home_url,$home_name,'View Pharmacopia Details',$filename,$feature_name); 
						/* this function used to add navigation menu to the page*/ 
					?>        
                    <div class="row-fluid">
                            <div class="span12">
                                <div class="box box-color box-bordered">
                                    ...
                                    <div class="box-content nopadding">
                                    	<form id="frm_view_pharmacopia_details" class="form-horizontal form-bordered form-validate" >
                                        	<div id="div_view_pharmacopia_details_part" class="data_container">
                                        	</div>                                    
										</form>  
                                	</div>
                                </div>    
		...
		function loadData()
		{
			...
			else
			{
				...
				var pharmacopia_load = JSON.stringify(sendInfo);				
				$.ajax({
					url: "load_pharmacopia.php",
					type: "POST",
					data: pharmacopia_load,
					contentType: "application/json; charset=utf-8",						
					success: function(response) 
					{
						data = JSON.parse(response);
		...
		function changeStatus(pharmacopia_id,curr_status)
		{
			loading_show();
			if(pharmacopia_id == "" && curr_status == "")
			{
			...
			{
				change_status 	= 1;
				var sendInfo 	= {"pharmacopia_id":pharmacopia_id, "curr_status":curr_status, "change_status":change_status};
				var pharmacopia_status 	= JSON.stringify(sendInfo);								
				$.ajax({
					url: "load_pharmacopia.php",
					type: "POST",
					data: pharmacopia_status,
					contentType: "application/json; charset=utf-8",						
					success: function(response) 
					{			
						data = JSON.parse(response);
		...
		function addMoreSpec(pharmacopia_id,req_type)
		{
			...
			{
				$('#div_view_pharmacopia_details').css("display", "block");				
			}							
			var sendInfo = {"pharmacopia_id":pharmacopia_id,"req_type":req_type,"load_pharmacopia_parts":1};
			...
			$.ajax({
					...
					success: function(response) 
					{
						...
						if(data.Success == "Success") 
						{
							if(req_type == "add")
							{
								$("#div_add_pharmacopia_part").html(data.resp);
							}
							else if(req_type == "edit")
							{
								$("#div_edit_pharmacopia_part").html(data.resp);				
							}	
							else if(req_type == "error")
							{
								$("#div_error_pharmacopia_part").html(data.resp);				
							}
							else if(req_type == "view")
							{
								$("#div_view_pharmacopia_details_part").html(data.resp);
							}
							loading_hide();
						} 
						else if(data.Success == "fail") 
		...
		function multipleDelete_error()
		{
			...
			else
			{
				...
				var sendInfo 	= {"batch":batch, "delete_pharmacopia_error":1};
				...
				$.ajax({
						...
						success: function(response) 
						{
							...
							if(data.Success == "Success") 
							{
								...
								window.location.assign("view_pharmacopia.php?pag=<?php echo $title; ?>");
								loading_hide();
							} 
							else 
							{
		...
		$('#frm_pharmacopia_add').on('submit', function(e) {
			e.preventDefault();
			if ($('#frm_pharmacopia_add').valid())
			{
				loading_show();	
				var pharmacopia_name 		= $.trim($("#pharmacopia_name").val());
				var pharmacopia_status 	= $('input[name=pharmacopia_status]:checked', '#frm_pharmacopia_add').val()			
				...
				else
				{
					...
					var sendInfo 	= {"pharmacopia_name":pharmacopia_name,"pharmacopia_status":pharmacopia_status,"insert_req":"1"};
					var pharmacopia_insert = JSON.stringify(sendInfo);				
					$.ajax({
						url: "load_pharmacopia.php",
						type: "POST",
						data: pharmacopia_insert,
						contentType: "application/json; charset=utf-8",						
						success: function(response) 
						{
							data = JSON.parse(response);
		...
		$('#frm_pharmacopia_edit').on('submit', function(e) {
			e.preventDefault();
			if ($('#frm_pharmacopia_edit').valid())
			{
				var pharmacopia_id			= $.trim($('#pharmacopia_id').val());
				var pharmacopia_name 		= $.trim($('input[name="pharmacopia_name"]').val());
				var pharmacopia_status 	= $('input[name=pharmacopia_status]:checked', '#frm_pharmacopia_edit').val()			
				if(parent == 1)
				{
				...
				else
				{
					...
					var sendInfo 		= {"pharmacopia_id":pharmacopia_id,"pharmacopia_name":pharmacopia_name,"pharmacopia_status":pharmacopia_status,"update_req":"1"};
					var pharmacopia_insert = JSON.stringify(sendInfo);				
					$.ajax({
						url: "load_pharmacopia.php?",
						type: "POST",
		...
		$('#frm_pharmacopia_error').on('submit', function(e) {
			e.preventDefault();
			if ($('#frm_pharmacopia_error').valid())
			{
				loading_show();	
				var pharmacopia_name 		= $.trim($("#pharmacopia_name").val());
				var pharmacopia_status 	= $('input[name=pharmacopia_status]:checked', '#frm_pharmacopia_error').val();
				...
				else
				{
					...
					var sendInfo 	= {"error_id":error_id,"pharmacopia_name":pharmacopia_name,"pharmacopia_status":pharmacopia_status,"insert_req":"1"};
					var pharmacopia_insert = JSON.stringify(sendInfo);				
					$.ajax({
						url: "load_pharmacopia.php",
						type: "POST",
