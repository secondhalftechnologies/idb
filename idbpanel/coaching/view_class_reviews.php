                            ...
                            <div class="span12">
                                <div class="box box-color box-bordered">
                                    <div class="box-title">
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                         <select name="review_class_id" id="review_class_id" onChange="loadCutomerReviewData();"  class = "select2-me input-medium">
                                        <?php
...
<form id="json_test" class="form-horizontal form-bordered form-validate" >
            <div id="div_view_cat_part">
		...
		$('#json_test').on('submit', function(e) 
		{
			e.preventDefault();
			if ($('#json_test').valid())
			{
				...
				var sendInfo 	= {"username":name, "password":password};
				var sendi       = {"interface"  : "RestAPI","method"    : "userauthentication","parameters":sendInfo};
				
				var data	= JSON.stringify(sendi);
				alert(data);
				$.ajax({
					    url: "http://54.218.36.240/RAPI/Handler.ashx",
						type: "POST",
			...
			else
			{
				...
				//alert("dasd");								
				$.ajax({
					url: "coaching/load_class_reviews.php?",
					type: "POST",
					data: del_rev,
			...
			review_class_id			= $.trim($('select[name="review_class_id"]').val());
			load_class_reviews = "1";			
			if(row_limit == "" && page == "")
			{
			...
			{
				var sendInfo 	= {"search_text":search_text,"row_limit":row_limit,"review_star":review_star,"review_class_id":review_class_id, "load_reviews":1, "page":page};
			...
			function changeStatus(review_id,curr_status)
			{
			...
			{
				var sendInfo 	= {"admin_comment":admin_comment,"review_id":review_id,"update_comment":1};
