...
<link href="bootstrap-timepicker.css" rel="stylesheet" type="text/css" />
...
<!-- datepicker end here-->
    ...
    <body class="<?php echo $theme_name; ?>" data-theme="<?php echo $theme_name; ?>">
		...
		<div class="container-fluid" id="content">
            <div id="main" style="margin-left:0px !important">
                ...
                <div id="div_add_offering" style="display:none;">
				 ...
				 <div id="div_edit_Offering" style="display:none;">gggggg
                	<div class="container-fluid"> 
                        <?php 
                        /* this function used to add navigation menu to the page*/ 
		...
		<script type="text/javascript">
			...
			function loadData()
			{
				...
				else
				{
					...
					$.ajax({
						url: "coaching/load_coaching_class.php?",
						type: "POST",
						data: org_load,
						contentType: "application/json; charset=utf-8",						
						success: function(response) 
		...
		function getsubcat(req_type)
		{
			$('#catid').select2()
			$('select').select2();
			var cat_ids = $('#parent_catid').val();
			if(cat_ids.length==0)
			{
				return false;
			}
			...
			$.ajax({
			url: "coaching/coaching/load_coaching_class.php?",
			type: "POST",
			data: cat_data,
			contentType: "application/json; charset=utf-8",						
			success: function(response) 
